...
Upon opening the mapping tool, the inputs will be preset and a map will display. These presets may be changed based on your desired output. Below we outline the available options: \newline
...
-   **Climate stress** - Pertains to environmental stress on the pest.
